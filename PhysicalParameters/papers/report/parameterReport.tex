...
\begin{figure}[htbp]
    \begin{center}
        \includegraphics[width=4in]{images/yellow.jpg}
    \end{center}
...
\begin{table}[htbp]
	\begin{tabular}{ll}
		...
		Handlebars & Drop\\
	\end{tabular}
	\caption{Specifications of the Yellow Bicycle}
...
\begin{figure}[htbp]
    \begin{center}
        \includegraphics[width=4in]{images/browser.jpg}
    \end{center}
...
\begin{figure}[htbp]
    \begin{center}
        \includegraphics[width=4in]{images/browserIns.jpg}
    \end{center}
...
\begin{figure}[htbp]
    \begin{center}
        \includegraphics[width=4in]{images/pista.jpg}
    \end{center}
...
\begin{figure}[htbp]
    \begin{center}
        \includegraphics[width=4in]{images/fisher.jpg}
    \end{center}
...
\begin{table}
    ...
    \begin{tabular}{ll}
        Geometry & Genisis\\
        Frame & Aluminum, Damping, AC/DC, Carbon, Composite\\
        Front Wheel & DT Swiss XR4.1 Ceramic 559 17\\
        Tires & Michelin 26'' X 2.00 (5.2-559)\\
        Rear Wheel & DT Swiss 240s\\
        Rear hub & 9 speed\\
        Rear derailleur & SRAM X-0\\
        Crank & Bonterager 3-speed\\
        Seat post & Ritchey\\
        Fork & SID Rock Shox
    \end{tabular}
    \caption{Specifications of the Gary Fisher Mountain Bike}
    \label{tab:gary}
\end{table}
...
\begin{figure}[htbp]
    \begin{center}
        \includegraphics[width=4in]{images/crescendo.jpg}
    \end{center}
...
\begin{figure}[htbp]
    \begin{center}
        \includegraphics[width=4in]{images/stratos.jpg}
    \end{center}
...
\begin{figure}[tbp]
    \begin{center}
        \includegraphics[width=4in]{../data/pendDat/graphs/BrowserFrameCompoundFirst1.png}
    \end{center}
...
\begin{figure}[htpb]
    \begin{center}
        \includegraphics[width=4in]{../data/pendDat/graphs/CrescendoForkTorsionalFirst2.png}
    \end{center}
...
\section{Parameters}
\subsection{Batavus Browser}
\subfile{../parTables/BatavusBrowserPar.tex}
\subsection{Batavus Browser Instrumented}
\subfile{../parTables/BatavusBrowserInstrumentedPar.tex}
\subsection{Batavus Crescendo Deluxe}
\subfile{../parTables/BatavusCrescendoDeluxePar.tex}
\subsection{Gary Fisher}
\subfile{../parTables/GaryFisherPar.tex}
\subsection{Bianchi Pista}
\subfile{../parTables/BianchiPistaPar.tex}
\subsection{Batavus Stratos Deluxe}
\subfile{../parTables/BatavusStratosDeluxePar.tex}
\subsection{Yellow Bike}
\subfile{../parTables/YellowBikePar.tex}
\subsection{Yellow Bike Reversed Fork}
\subfile{../parTables/YellowBikeReversedForkPar.tex}
...
\subfile{../data/bikeCanonical/BatavusBrowserCan.tex}
\subsubsection{Batavus Browser Instrumented}
\subfile{../data/bikeCanonical/BatavusBrowserInstrumentedCan.tex}
\subsubsection{Batavus Crescendo Deluxe}
\subfile{../data/bikeCanonical/BatavusCrescendoDeluxeCan.tex}
\subsubsection{Gary Fisher}
\subfile{../data/bikeCanonical/GaryFisherCan.tex}
\subsubsection{Bianchi Pista}
\subfile{../data/bikeCanonical/BianchiPistaCan.tex}
\subsubsection{Batavus Stratos Deluxe}
\subfile{../data/bikeCanonical/BatavusStratosDeluxeCan.tex}
\subsubsection{Yellow Bike}
\subfile{../data/bikeCanonical/YellowBikeCan.tex}
\subsubsection{Yellow Bike Reversed Fork}
\subfile{../data/bikeCanonical/YellowBikeReversedForkCan.tex}
