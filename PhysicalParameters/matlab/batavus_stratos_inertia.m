% File: batavus_stratos_inertia.m
% Date: March 24, 2010
% Author: Jason Moore
% Description: Calculates the benchmark inertia matrices of the Batavus
% Stratos frame and fork/handlebar from the experiments.
clear all
close all
clc
...
%      -Ixy  Iyy -Iyz
%      -Ixz -Iyz  Izz]
%------------Batavus Stratos rear frame ----------------------------------%
mBF = 7.2199999999999998;  % [kg] mass of the rear frame
xBF = 0.32669395; % [m] cg location in benchmark coordinate system
zBF = -0.48249332; % [m] cg location in the benchmark coordinate system
...
TBF1 = 1.81602013;   % [s] period of oscillation when hung from the top tube
TBF2 = 1.58525347;   % [s] period of oscillation when hung from the down tube
TBF3 = 1.66025349;   % [s] period of oscillation when hung from the fender
...
%-------------Batavus Stratos front frame (handlbar and fork)-------------%
mH  =  3.04;    % [kg] mass of the front handlebar and fork assembly
xH  =  0.90890237;   % [m] cg location in benchmark coordinate system
zH  = -0.72963169;   % [m] cg location in the benchmark coordinate system
% a period of ten oscillations was measured with a pocket watch through 3
% different planar axes each 3 different times and averaged
TH1 =  1.01152671;     % [s] period of oscillation when hung from the steer tube
TH2 =  0.52537523;     % [s] period of oscillation when hung from the fender behind the fork
TH3 =  1.08609598;     % [s] period of oscillation when hung from the fender in front of the fork
k   =  5.6248209199363393;  % [Nm/rad] stiffness of the torsion rod, from page 43 of
% moments of inertia [Nm*s^2] about the 1st, 2nd, and 3rd test axes
IHx1 = k*TH1^2/4/pi^2;
IHx2 = k*TH2^2/4/pi^2;
...
% Jason
IBRJ = [6.8639 0 -0.4498;0 IBRJyy 0;-0.4498 0 2.3804];
mBRJ = 72;       % [kg] total body mass
xBRJ  = 0.4509;   % [m] x cg location
zBRJ  = -1.03; % [m] z cg location
