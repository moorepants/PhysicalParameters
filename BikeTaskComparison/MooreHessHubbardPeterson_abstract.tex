...
\begin{figure}[tb]
    \centering
    \subfloat[Lane Change Performance]{\label{fig:path}\includegraphics[width=0.4\columnwidth]{path.png}}
    \subfloat[Handling Qualities Sensitivity Functions]{\label{fig:handling}\includegraphics[width=0.4\columnwidth]{handling.png}}

    \subfloat[Rider Steering Inputs]{\label{fig:steer}\includegraphics[width=0.4\columnwidth]{steer.png}}
    \subfloat[Bode Diagrams of Rider/Bicycle Open-Loop Transfer
    Functions]{\label{fig:bode}\includegraphics[width=0.4\columnwidth]{bode.png}}
