...
\begin{figure}[tb]
    ...
    \subfloat[]{\label{fig:triangle}\includegraphics[width=3in]{../../../figures/triangle.pdf}}
...
\begin{figure}[tb]
	\begin{center}
		\includegraphics[width=3in]{../../../images/level.jpg}
	\end{center}
...
\begin{figure}[tbp]
    ...
    \subfloat[]{
        \label{fig:FwheelTor}
        \includegraphics[width=3in]{../../../images/CrescendoFwheelTorsionalFirst.jpg}
    }
    \quad
    \subfloat[]{
        \label{fig:wheelIyy}
        \includegraphics[width=3in]{../../../images/wheelIyy.jpg}
    }
