...
\begin{column}{\onecolwid}
  \begin{block}{Introduction}
    ...
    geometry, mass, mass location and mass distributions of each rigid body
    must be measured. In particular, we are concerned with the measurement of
    the minimal bicycle
    parameters required for the benchmark bicycle presented
    in~\cite{Meijaard2007}. A set of 25 parameters is used to populate the
    model.
    ...
    that can be used with, but not limited to, the benchmark bicycle model. The
    accuracy of all the measurements are presented along with a comparison of
...
\begin{column}{\twocolwid}
  ...
  \begin{block}{Accuracy}
    \rmfamily{
    Following the vain of \cite{Roland1971} we used error propagation theory to
    calculate accuracy of the 25 benchmark bicycle parameters. We estimate
    ...
    \begin{equation}
        ...
        \label{eqn:variance}
    \end{equation}
    where $s_*$ is the variance and $s_{**}$ is the covariance. If $u$ and $v$ are uncorrelated then $s_{uv}=0$ but the cross correlations
  ...
  \begin{columns}[t, totalwidth=\twocolwid]
    ...
    \begin{column}{\onecolwid}
        ...
        \begin{block}{Measurements}
            \rmfamily{
            We attempted to directly measure the trail, wheelbase and wheel
            diameters with various techniques. We measured the mass centers of
            the four bodies (fork, frame, and wheels) by hanging the bodies by
            their mass centers. The moments of inertia were estimated by
            hanging the bodies as both torsional and compound pendulums and
            measuring the period of oscillation which is correlated to the
            inertia.
            }
            \begin{center}
              \includegraphics[width=0.90\onecolwid]{../../../figures/angles.pdf}
            \end{center}
        \end{block}
...
% The fourth column
\begin{column}{\onecolwid}
  \begin{alertblock}{Bike Eigenanalysis}
    \rmfamily{
    ...
    \end{center}
    \rmfamily{
    Less variation is seen among the bicycles when the mass and inertia of a
    rigid rider is added.
    }
    \\
    \begin{center}
...
\begin{column}{\onecolwid}
  % Frequency Response
  \begin{block}{Bike Frequency Response}
    \rmfamily{
    The steer torque to roll angle Bode plot reveals up to 10 dB variation
    among the bikes along the frequencies shown.
    \\
    \begin{center}
      \includegraphics[width=.9\onecolwid]{../../../plots/Bike/Bode/Tdel2phi.pdf}
    \end{center}
    }
  \end{block}

  % Frequency Response
  \begin{block}{Bike/Rider Frequency Response}
    \centering
    \includegraphics[width=.9\onecolwid]{../../../plots/BikeRider/Bode/Tdel2phi.pdf}
  \end{block}
