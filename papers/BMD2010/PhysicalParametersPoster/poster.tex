...
\begin{column}{\twocolwid}
  ...
  \begin{alertblock}{Bicycle Eigenanalysis}
    ...
    differences of the bicycles. The bicycles also exhibit a two imaginary root
    pairs at low speeds.
    }
    \\
    \begin{center}
    ...
    rigid rider is added, except in the stable sppeed ranges.
    }
    \\
    \begin{center}
...
\begin{column}{\onecolwid}
        \begin{block}{Measurements}
            ...
            wheels) directly using an precision scale. We found the location of
            ...
            fitting a decaying osciallation function to a voltage signal from a
...
\begin{column}{\onecolwid}
  % Frequency Response
  \begin{alertblock}{Bicycle Frequency Response}
    \small{\rmfamily{
    The steer torque to roll angle Bode plot reveals up to 10 dB variation
    among the bikes and variation in phase.
    }}
    \\
    \begin{center}
